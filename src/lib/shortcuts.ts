...
export const FIXED_SHORTCUTS: FixedShortcut[] = [
	{ labelKey: "actions.cycleForward", display: "Tab", bindings: [{ key: "tab" }] },
	{
		labelKey: "actions.cycleBackward",
		display: "Shift + Tab",
		bindings: [{ key: "tab", shift: true }],
	},
	{
		labelKey: "actions.deleteSelectedAlt",
		display: "Del / ⌫",
		bindings: [{ key: "delete" }, { key: "backspace" }],
	},
	{ labelKey: "actions.panTimeline", display: "Shift + Ctrl + Scroll", bindings: [] },
	{ labelKey: "actions.zoomTimeline", display: "Ctrl + Scroll", bindings: [] },
];
...
export const SHORTCUT_LABELS: Record<ShortcutAction, string> = {
	addZoom: "actions.addZoom",
	addTrim: "actions.addTrim",
	addSpeed: "actions.addSpeed",
	addAnnotation: "actions.addAnnotation",
	addKeyframe: "actions.addKeyframe",
