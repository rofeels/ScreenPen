...
import type {
	CursorTelemetryPoint as SharedCursorTelemetryPoint,
	NativeMacRecordingOptions,
	ProcessedDesktopSource as SharedProcessedDesktopSource,
	RecordingSessionData,
	SelectedSource,
	SystemCursorAsset as SharedSystemCursorAsset,
} from "./ipc/contracts";
...
declare global {
	...
	interface Window {
		electronAPI: {
			...
			showSourceHighlight: (source: SelectedSource) => Promise<{ success: boolean }>;
			...
			setCurrentRecordingSession: (session: RecordingSessionData) => Promise<{ success: boolean }>;
	...
	type ProcessedDesktopSource = SharedProcessedDesktopSource;
	type CursorTelemetryPoint = SharedCursorTelemetryPoint;
	type SystemCursorAsset = SharedSystemCursorAsset;
}
